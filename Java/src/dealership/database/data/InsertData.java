...
public class InsertData {
	...
	public static void insertAddress(Address address) {
		...
		try {
			...
			String sql = "INSERT INTO ADDRESS (ID_ADDRESS, CPF_CUSTOMER, STATE, CITY, ZIP_CODE, STREET, NUMBER, COMPLEMENT) VALUES ("
					+ address.getIdAdress() + ", " + address.getCPF_customer() + ", '" + address.getState() + "', '"
					+ address.getCity() + "', " + address.getZIP_code() + ", '" + address.getStreet() + "', "
	...
	public static void insertCar(Car car, TypeSale typesale) {
		...
		try {
			...
			if (typesale.getSaleItem() == 1) {
				sql = "INSERT INTO CAR (CHASSI, CAR_MODEL, CAR_YEAR, CAR_COLOR, CAR_PRICE) VALUES ('" + car.getChassi()
						+ "', '" + car.getCarModel() + "', " + car.getCarYear() + ", '" + car.getCarCollor() + "', "
						+ car.getCarPrice() + ")";
			} else {
				sql = "INSERT INTO CAR (CHASSI, CAR_MODEL, CAR_YEAR, CAR_COLOR) VALUES ('" + car.getChassi() + "', '"
						+ car.getCarModel() + "', " + car.getCarYear() + ", '" + car.getCarCollor() + "')";
			}
	...
	public static void insertCustomer(Customer customer) {
		...
		try {
			...
			String sql = "INSERT INTO CUSTOMER (CPF_CUSTOMER, NAME_CUSTOMER) VALUES (" + customer.getCPF_customer()
	...
	public static void insertCustomerCard(CustomerCard customerCard) {
		...
		try {
			...
			String sql = "INSERT INTO CUSTOMER_CARD (CARD_NUMBER, CARD_OWNER, CARD_VALID, CVV, CPF_CUSTOMER) VALUES ("
					+ customerCard.getCardNumber() + ", '" + customerCard.getCardOwner() + "', '"
					+ customerCard.getCardValid() + "', " + customerCard.getCVV() + ", "
	...
	public static void insertMechanic(Mechanic mechanic) {
		...
		try {
			...
			String sql = "INSERT INTO MECHANIC (CPF_MECHANIC, NAME_MECHANIC) VALUES (" + mechanic.getCPF_mechanic()
	...
	public static void insertPartCar(PartCar partCar) {
		...
		try {
			...
			String sql = "INSERT INTO PART_CAR (SERIAL_NUMBER, PART_NAME, PART_PRICE) VALUES ("
					+ partCar.getSerialNumber() + ", '" + partCar.getPartName() + "', " + partCar.getPartPrice() + ")";
	...
	public static void insertSale(Sale sale) {
		...
		try {
			...
			String sql = "INSERT INTO SALE (ID_SALE, SALE_DATE, CPF_CUSTOMER, CPF_SELLER) VALUES (" + sale.getIdSale()
					+ ", '" + sale.getSaleDate() + "', " + sale.getCPFcustomer() + ", " + sale.getCPFseller() + ")";
...
//	        System.out.println("Venda inserida com sucesso!");
	...
	public static void insertSeller(Seller seller) {
		...
		try {
			...
			String sql = "INSERT INTO SELLER (CPF_SELLER, NAME_SELLER) VALUES (" + seller.getCPFseller() + ", '"
	...
	public static void insertService(Service service) {
		...
		try {
			...
			String sql = "INSERT INTO SERVICE (ID_SERVICE, SERVICE_NAME, SERVICE_DATE, SERVICE_PRICE, CHASSI, CPF_CUSTOMER, CPF_MECHANIC) VALUES ("
					+ service.getIdService() + ", '" + service.getServiceName() + "', '" + service.getServiceDate()
					+ "', " + service.getServicePrice() + ", '" + service.getChassi() + "', "
					+ service.getCPF_customer() + ", " + service.getCPF_mechanic() + ")";
	...
	public static void insertTypeSale(TypeSale typeSale) {
		...
		try {
			...
			String sql = "INSERT INTO TYPE_SALE (ID_TYPE_SALE, SALE_ITEM) VALUES (" + typeSale.getIDTypeSale() + ", '"
